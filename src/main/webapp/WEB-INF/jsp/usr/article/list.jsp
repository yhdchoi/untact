		    ...
		    <div class="card bordered shadow-lg">
				...
				<form action="" class="grid gap-2 px-4 py-4">
					...
					<div class="form-control">
						...
						</label> <select class="select select-bordered" name="searchType">
					...
					<div class="form-control">
						...
						</label> <input value="${param.keyword}" class="input input-bordered"
...
<div class="section section-article-list mt-8">
	<div class="container mx-auto">
					...
					<c:forEach items="${articles}" var="article">
						...
						<div class="px-4 py-8">
							...
							<div class="plain-link-wrap gap-3 mt-4">
								<a href="${detailUri}" class="plain-link" title="자세히 보기"> <span><i
										class="fas fa-info"></i></span> <span>자세히 보기</span>
								</a> 
		...
		<div class="pages mt-4 mb-4 text-center">
			...
			<c:set var="uriBase" value="${uriBase}&keyword=${param.keyword}" />
