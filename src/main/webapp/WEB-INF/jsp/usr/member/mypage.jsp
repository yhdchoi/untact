            ...
            <div class="px-4 py-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <a href="#" class="order-2 hover:underline">
                        ...
                        <span>${rq.loggedInMember.id}</span>
                    </a>

                    <a href="#" class="cursor-pointer order-3 hover:underline">
                        <span class="badge badge-accent">회원타입</span>
                        <span>${rq.loggedInMember.authLevelName}</span>
                    </a>

                    <a href="#" class="order-4 hover:underline">
                        <span class="badge">등록날짜</span>
                        <span class="text-gray-600 text-light">${rq.loggedInMember.regDate}</span>
                    </a>

                    <a href="#" class="order-5 hover:underline">
                        <span class="badge">수정날짜</span>
                        <span class="text-gray-600 text-light">${rq.loggedInMember.updateDate}</span>
                    </a>

                    <a href="#" class="order-6 hover:underline">
                        <span class="badge">로그인아이디</span>
                        <span class="text-gray-600">${rq.loggedInMember.loginId}</span>
                    </a>

                    <a href="#" class="order-7 hover:underline">
                        <span class="badge">이름</span>
                        <span class="text-gray-600">${rq.loggedInMember.name}</span>
                    </a>

                    <a href="#" class="order-8 sm:order-4 md:order-8 hover:underline">
                        <span class="badge">별명</span>
                        <span class="text-gray-600">${rq.loggedInMember.nickname}</span>
                    </a>
                </div>

                <div class="grid grid-item-float gap-3 mt-4">
                    <a href="../member/checkPassword?afterUri=${Util.getUriEncoded('../member/edit')}" class="text-blue-500 hover:underline">
                        <span>
